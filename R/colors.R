...
#' 
#' A collection of some original and some borrowed color palettes to provide appealing color aesthetics for plots in viewmastR
#' 
#' @export
viewmastrPal<- list(
  ...
  fallDay = c("1" = "#9cb9cd", "2" = "#594286","3"="#bd9895", "4"="#6f9a93", "5"= "#5b914d","6"= "#45709b", "7"="#d77e42"),
  springTime = c("1"="#df76a4","2"="#5ca867","3"="#336eae","4"="#ea9a50", "5"="#d0493d","6"="#7b5fa2","7"="#88c7c0","8"= "#4c9096"),
  acidRain = c("1"="#9893DA","2"="#ebeb78","3"="#fa9f42","4"="#810e44","5"="#d94745","6"="#00B0E0","7"="#3e5e8e","8"= "#0b6e4f","9"= "#b8e3ac"),
...
#'
#' @param set The name of a color palette provided in the `viewmastrPal` list object.
#' @param n The number of unique colors to generate as part of this continuous color palette.
#' @param reverse A boolean variable that indicates whether to return the palette colors in reverse order.
#' @export
pal_continuous <- function(
    set = "solarExtra", 
    n = 256, 
    reverse = FALSE
){
