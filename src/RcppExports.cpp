...
// bagging
af::array bagging(RcppArrayFire::typed_array<f32> train_feats, RcppArrayFire::typed_array<f32> test_feats, RcppArrayFire::typed_array<s32> train_labels, RcppArrayFire::typed_array<s32> test_labels, int num_classes, RcppArrayFire::typed_array<f32> query, bool verbose, int num_models, int sample_size, int device);
RcppExport SEXP _viewmaster_bagging(SEXP train_featsSEXP, SEXP test_featsSEXP, SEXP train_labelsSEXP, SEXP test_labelsSEXP, SEXP num_classesSEXP, SEXP querySEXP, SEXP verboseSEXP, SEXP num_modelsSEXP, SEXP sample_sizeSEXP, SEXP deviceSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(bagging(train_feats, test_feats, train_labels, test_labels, num_classes, query, verbose, num_models, sample_size, device));
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(af_dbn(train_feats, test_feats, train_target, test_target, num_classes, query_feats, device, dts, rbm_learning_rate, nn_learning_rate, rbm_epochs, nn_epochs, batch_size, max_error, verbose));
    return rcpp_result_gen;
END_RCPP
}
// dbn_demo
...
// lr
af::array lr(RcppArrayFire::typed_array<f32> train_feats, RcppArrayFire::typed_array<f32> test_feats, RcppArrayFire::typed_array<s32> train_targets, RcppArrayFire::typed_array<s32> test_targets, int num_classes, RcppArrayFire::typed_array<f32> query, bool verbose, int device);
RcppExport SEXP _viewmaster_lr(SEXP train_featsSEXP, SEXP test_featsSEXP, SEXP train_targetsSEXP, SEXP test_targetsSEXP, SEXP num_classesSEXP, SEXP querySEXP, SEXP verboseSEXP, SEXP deviceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< RcppArrayFire::typed_array<f32> >::type train_feats(train_featsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< int >::type device(deviceSEXP);
    rcpp_result_gen = Rcpp::wrap(lr(train_feats, test_feats, train_targets, test_targets, num_classes, query, verbose, device));
    return rcpp_result_gen;
END_RCPP
}
// lr_demo
...
// naive_bayes
af::array naive_bayes(RcppArrayFire::typed_array<f32> train_feats, RcppArrayFire::typed_array<f32> test_feats, RcppArrayFire::typed_array<s32> train_labels, RcppArrayFire::typed_array<s32> test_labels, int num_classes, RcppArrayFire::typed_array<f32> query, bool verbose, int device);
RcppExport SEXP _viewmaster_naive_bayes(SEXP train_featsSEXP, SEXP test_featsSEXP, SEXP train_labelsSEXP, SEXP test_labelsSEXP, SEXP num_classesSEXP, SEXP querySEXP, SEXP verboseSEXP, SEXP deviceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< RcppArrayFire::typed_array<f32> >::type train_feats(train_featsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< int >::type device(deviceSEXP);
    rcpp_result_gen = Rcpp::wrap(naive_bayes(train_feats, test_feats, train_labels, test_labels, num_classes, query, verbose, device));
    return rcpp_result_gen;
END_RCPP
}
// naive_bayes_demo
...
RcppExport SEXP _viewmaster_af_nn(SEXP train_featsSEXP, SEXP test_featsSEXP, SEXP train_targetSEXP, SEXP test_targetSEXP, SEXP num_classesSEXP, SEXP query_featsSEXP, SEXP deviceSEXP, SEXP dtsSEXP, SEXP learning_rateSEXP, SEXP max_epochsSEXP, SEXP batch_sizeSEXP, SEXP max_errorSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< RcppArrayFire::typed_array<f32> >::type train_feats(train_featsSEXP);
    ...
    Rcpp::traits::input_parameter< float >::type max_error(max_errorSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(af_nn(train_feats, test_feats, train_target, test_target, num_classes, query_feats, device, dts, learning_rate, max_epochs, batch_size, max_error, verbose));
    return rcpp_result_gen;
END_RCPP
}
// ann_demo
int ann_demo(int device, int perc, std::string dts, bool verbose);
RcppExport SEXP _viewmaster_ann_demo(SEXP deviceSEXP, SEXP percSEXP, SEXP dtsSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type device(deviceSEXP);
    ...
    Rcpp::traits::input_parameter< std::string >::type dts(dtsSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(ann_demo(device, perc, dts, verbose));
    return rcpp_result_gen;
END_RCPP
}
// perceptron
...
// smr
af::array smr(RcppArrayFire::typed_array<f32> train_feats, RcppArrayFire::typed_array<f32> test_feats, RcppArrayFire::typed_array<s32> train_targets, RcppArrayFire::typed_array<s32> test_targets, int num_classes, RcppArrayFire::typed_array<f32> query, bool verbose, int device);
RcppExport SEXP _viewmaster_smr(SEXP train_featsSEXP, SEXP test_featsSEXP, SEXP train_targetsSEXP, SEXP test_targetsSEXP, SEXP num_classesSEXP, SEXP querySEXP, SEXP verboseSEXP, SEXP deviceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< RcppArrayFire::typed_array<f32> >::type train_feats(train_featsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< int >::type device(deviceSEXP);
    rcpp_result_gen = Rcpp::wrap(smr(train_feats, test_feats, train_targets, test_targets, num_classes, query, verbose, device));
    return rcpp_result_gen;
END_RCPP
}
// smr_demo
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_viewmaster_bagging", (DL_FUNC) &_viewmaster_bagging, 10},
    {"_viewmaster_af_dbn", (DL_FUNC) &_viewmaster_af_dbn, 15},
    {"_viewmaster_dbn_demo", (DL_FUNC) &_viewmaster_dbn_demo, 3},
    {"_viewmaster_lr", (DL_FUNC) &_viewmaster_lr, 8},
    {"_viewmaster_lr_demo", (DL_FUNC) &_viewmaster_lr_demo, 2},
    {"_viewmaster_naive_bayes", (DL_FUNC) &_viewmaster_naive_bayes, 8},
    ...
    {"_viewmaster_af_nn", (DL_FUNC) &_viewmaster_af_nn, 13},
    {"_viewmaster_ann_demo", (DL_FUNC) &_viewmaster_ann_demo, 4},
    {"_viewmaster_perceptron", (DL_FUNC) &_viewmaster_perceptron, 8},
    {"_viewmaster_perceptron_demo", (DL_FUNC) &_viewmaster_perceptron_demo, 3},
    {"_viewmaster_smr", (DL_FUNC) &_viewmaster_smr, 8},
