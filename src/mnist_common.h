...
static void setup_mnist(int *num_classes, int *num_train, int *num_test,
    ...
    read_idx(idims, idata, "/Users/sfurlan/develop/viewmaster/src/examples/data/mnist/images-subset");

    std::vector<dim_t> ldims;
    std::vector<unsigned> ldata;
    read_idx(ldims, ldata, "/Users/sfurlan/develop/viewmaster/src/examples/data/mnist/labels-subset");
